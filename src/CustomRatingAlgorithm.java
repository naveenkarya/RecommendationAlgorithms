...
public class CustomRatingAlgorithm extends RatingAlgorithm {
    ...
    public CustomRatingAlgorithm(List<List<Double>> trainingData, List<Double> avgUserRatingsForMovies, String similarityMetric1, String similarityMetric2, double threshold) {
